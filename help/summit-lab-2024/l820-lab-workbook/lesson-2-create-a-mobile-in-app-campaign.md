...
您可以在实验室计算机桌面上找到登录的详细信息。 使用Adobe ID和密码。
   ...
   ![登录屏幕](/help/summit-lab-2024/l820-lab-workbook/assets/2-1-1-ajo-sign-in.png)
   <br>
3. 您可以跳过以下两个屏幕：
   <br>
   ![电话号码](/help/summit-lab-2024/l820-lab-workbook/assets/2-1-3-ajo-add-phone.png)
   <br>
   ![Personalization弹出窗口](/help/summit-lab-2024/l820-lab-workbook/assets/2-1-4-ajo-personalization-pop-up.png)
...
>
>![AJO主页](/help/summit-lab-2024/l820-lab-workbook/assets/2-1-5-ajo-homepage.png)
...
1. 单击&#x200B;**[!UICONTROL 创建]**。
   ...
   ![应用表面](/help/summit-lab-2024/l820-lab-workbook/assets/3-1-1-1-create.png)

>[!SUCCESS]
>
>现在，您应该位于Campaign属性上：
>
> ![营销活动属性](/help/summit-lab-2024/l820-lab-workbook/assets/3-1-1-2-campaign-properties.png)
...
![属性节](/help/summit-lab-2024/l820-lab-workbook/assets/3-1-2-1-properties-section.png)
...
1. 在规则生成器中，单击&#x200B;**[!UICONTROL 应用程序启动项]**，然后从下拉列表中选择&#x200B;*将数据发送到Platform*。
   ![发送到数据平台](/help/summit-lab-2024/l820-lab-workbook/assets/trigger-drop-down-sent-to-platform.png)
...
1. 要保存该值，请单击**[!UICONTROL 添加**] `<custom string value>`。
   ...
   ![添加自定义触发器字符串值](/help/summit-lab-2024/l820-lab-workbook/assets/3-1-2-2-add-custom-trigger.png)
...
>
>![定义了自定义触发器的Campaign](/help/summit-lab-2024/l820-lab-workbook/assets/3-1-2-2-campaign-with-custom-trigger.png)
...
![模式按钮](/help/summit-lab-2024/l820-lab-workbook/assets/3-1-3-2-modal-button.png)
...
2. 在以下&#x200B;**[!UICONTROL 内容]**&#x200B;部分中，添加您自己的自定义文本，以便显示在您对&#x200B;**[!UICONTROL 标头]**&#x200B;和&#x200B;**[!UICONTROL 正文]**&#x200B;的邮件中。
   ...
   ![标头和正文](/help/summit-lab-2024/l820-lab-workbook/assets/3-1-3-2-content.png)

3. 其他选项：
   1. **按钮：**

      ![按钮部分](/help/summit-lab-2024/l820-lab-workbook/assets/3-1-3-2-buttons.png)
   ...
   2. **高级格式化**
      ...
      ![高级格式切换](/help/summit-lab-2024/l820-lab-workbook/assets/3-1-3-2-advanced-formatting-toggle.png)
      ...
      ![高级格式化选项](/help/summit-lab-2024/l820-lab-workbook/assets/3-1-3-2-advanced-formatting-options.png)

   3. **设置选项卡**

      通过切换到此选项卡并在&#x200B;**[!UICONTROL 预览]**&#x200B;分区中，您可以更改&#x200B;**应用程序预览**。
      <br>\
      ![设置选项卡](/help/summit-lab-2024/l820-lab-workbook/assets/3-1-3-1-settings-tab.png)
      <br>
...
4. 当您完成内容创作并对消息感到满意时，请单击&#x200B;**[!UICONTROL 查看以激活]按钮**。
   ...
   >
   >![查看并激活](/help/summit-lab-2024/l820-lab-workbook/assets/3-1-4-1-review-and-activate.png)
   >
   > 您将在此处看到消息的完整摘要。
   >
...
5. 如果您已完成审阅营销活动，请按激活按钮发布营销活动。
   <br>
   ![激活](/help/summit-lab-2024/l820-lab-workbook/assets/3-1-4-2-activate.png)
...
>
> ![已发布的营销活动](/help/summit-lab-2024/l820-lab-workbook/assets/3-1-3-2-published-campaign.png)
>
...
3. 现在，导航到应用程序上的练习选项卡。
   ...
   ![练习按钮](/help/summit-lab-2024/l820-lab-workbook/assets/3-2-3-app-exercise-button.png)

4. 在文本字段中，键入您在Campaign中定义的自定义触发器值。 然后按提交。


   ![修改](/help/summit-lab-2024/l820-lab-workbook/assets/3-2-2-1-app-condition.PNG){width="250" align="center" zoomable="yes"}

>[!SUCCESS]
>
>通过单击提交，您可以手动触发触发器，此时您创建的应用程序内通知会弹出：
>
>![应用程序内消息](/help/summit-lab-2024/l820-lab-workbook/assets/3-1-3-3-in-app-message.png)
>
...
1. 按&#x200B;**[!UICONTROL 复制按钮]**。 这将打开一个新提示，为您正在复制的新营销活动命名。 添加您容易记住或使用默认名称（默认添加&#x200B;**[!DNL _copy]**）的新名称。
   ...
   ![重复的营销活动](/help/summit-lab-2024/l820-lab-workbook/assets/3-2-duplicate-campaign.png)
...
1. 您可以在&#x200B;**[!UICONTROL Campaign审核]**&#x200B;页面或&#x200B;**[!UICONTROL Campaign作者]**&#x200B;步骤中访问“在设备上预览”功能。
   ...
   ![在设备上预览按钮](/help/summit-lab-2024/l820-lab-workbook/assets/3-3-1-1-preview-on-device-button.png)
   <br>

1. 接下来，从“连接到设备”屏幕单击&#x200B;**[!UICONTROL 开始按钮]**。

   ![开始按钮](/help/summit-lab-2024/l820-lab-workbook/assets/3-3-1-2-connect-to-device-start.png)
   <br>

1. 输入已配置为启动Fréscopa应用程序的基本URL： `dxdemo://`

   ![预览url](/help/summit-lab-2024/l820-lab-workbook/assets/3-3-1-3-preview-url.png)
...
1. 按照屏幕上的说明操作：
   ...
   ![输入pin](/help/summit-lab-2024/l820-lab-workbook/assets/3-3-1-5-enter-pin.PNG){width="250" align="center" zoomable="yes"}
   <br>
1. 此弹出窗口显示在计算机屏幕上

   ![弹出窗口](/help/summit-lab-2024/l820-lab-workbook/assets/3-3-pop-up.png)
