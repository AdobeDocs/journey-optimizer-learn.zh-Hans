...
>1. [在Adobe Journey Optimizer中生成并激活受众](https://experienceleague.adobe.com/en/courses/ajo-build-and-activate-audiences)
>2. [在Adobe Journey Optimizer中编排历程和行动营销活动](https://experienceleague.adobe.com/en/courses/ajo-design-and-manage-journeys-and-action-campaigns)
...
2. 确保已配置[推送渠道](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/web-and-mobile-channels/guided-channel-setup)。
...
1. 验证应用程序是否已与Mobile SDK集成并配置为适用于移动渠道。
