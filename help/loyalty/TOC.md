...
+ {hide-from-toc}[开始使用面向营销人员的Journey Optimizer忠诚度](./overview.md)
...
+ 配置挑战 {#configure-your-challenge}
  ...
  + {hide-from-toc}[通过忠诚度人工智能代理提出挑战并获得见解](./configure-your-challenge/create-challenges-and-get-insights-with-the-loyalty-ai-agent.md)
+ 申请并显示您的挑战 {#apply-and-display-your-challenge}
  + {hide-from-toc}[使用基于代码的体验构建挑战内容卡](./apply-and-display-your-challenge/build-a-challenge-content-card-with-a-code-based-experience.md)
