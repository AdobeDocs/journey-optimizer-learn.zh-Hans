---
title: 在 AJO 中使用联合受众进行多实体定位
description: 了解如何在 Adobe Journey Optimizer 中使用具有联合受众的多实体定位功能，按订阅 ID、帐户 ID 或订单 ID 来定位历程。
feature: Audiences
role: User
level: Beginner
...
了解如何使用多实体定位超越基于用户档案的受众，并使用联合受众提供更相关的客户体验。

此视频演示如何按订阅 ID、帐户 ID 或订单 ID 定位历程，以在单个客户与多个业务实体关联时实现更准确的受众激活和个性化参与。
