---
title: 为营销活动设置架构和数据集
description: 了解如何为 Adobe Journey Optimizer 营销活动定义架构、摄取数据和验证数据集。在几分钟内获得有关个性化和执行的洞察。
feature: Campaigns
role: Developer
level: Beginner
...
了解如何在 Adobe Journey Optimizer 中为精心策划的营销活动设置关系架构和数据集。本指南介绍如何定义键、关系和使用 DDL 文件高效地创建架构。您还将了解如何通过 CSV 上载和变更数据捕获 (CDC) 来摄取数据、验证数据集，以及准备它们以进行查询、个性化和营销活动执行。观看嵌入式视频，获取简化营销活动工作流的分步说明。
