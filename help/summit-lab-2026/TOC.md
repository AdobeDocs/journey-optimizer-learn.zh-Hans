---
user-guide-title: 适用于Adobe Journey Optimizer中Web体验的AI驱动型决策
user-guide-description: 在本实验中，您将学习如何使用Adobe Journey Optimizer构建决策系统。 您可以配置逻辑以根据客户的财务配置文件和实时操作来确定最适合的产品选件，然后通过Web横幅和短信以一致方式部署。
role: User
...
# 适用于Web体验的AI支持的决策 {#ai-powered-decisioning-for-web-experiences}

+ [简介](/help/summit-lab-2026/introduction.md)
+ [设置实验室环境](/help/summit-lab-2026/set-up-the-lab-environment.md)
