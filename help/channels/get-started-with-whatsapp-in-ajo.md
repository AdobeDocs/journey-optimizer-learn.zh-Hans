...
description: 了解如何在 Adobe Journey Optimizer 中将 WhatsApp 集成为原生渠道，以安全、实时和大规模的方式投放个性化消息。
feature: Whatsapp
role: Admin, User
...
了解如何在 Adobe Journey Optimizer 中将 WhatsApp 集成为原生渠道，以安全、实时和大规模的方式投放个性化消息。
