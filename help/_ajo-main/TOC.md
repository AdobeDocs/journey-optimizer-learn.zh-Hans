...
+ 历程 {#create-journeys}
   + [历程Designer — 概述](/help/create-journeys/journey-designer-overview.md)
...
+ 渠道 {#channels}
   ...
   + 短信渠道{#sms-channel}
      + [SMS/MMS消息 — 概述](/help/channels/sms-mms-messages-overview.md)
   ...
   + Web 渠道 {#web-channel}
      + [Web个性化 — 概述](/help/channels/web-personalization-overview.md)
...
+ 内容管理{#content-management}
   ...
   + [数字资产管理 — 概述](/help/content-management/digital-asset-management-overview.md)
   ...
   + AI 助手内容加速器{#content-accelerator}
      + [AI Assistant内容加速器 — 概述](/help/content-management/ai-assistant-content-accelerator-overview.md)
      + [使用AI Assistant内容加速器创建内容](/help/content-management/create-content-using-the-ai-assistant-content-accelerator.md)
+ 个性化内容{#personalize-content}
   + [Personalization编辑器 — 概述](/help/personalize-content/personalization-editor-overview.md)
...
+ 报告和监测{#report-and-monitor}
   + [测量和报表 — 概述](/help/report-and-monitor/measurement-and-reporting-overview.md)
