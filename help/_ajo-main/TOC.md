...
+ Journey Optimizer 简介 {#introduction-to-journey-optimizer}
  ...
  + {hide-from-toc}[架构](/help/introduction/architecture.md)
...
+ 营销活动 {#create-campaigns}
  + 操作营销活动 {#action-campaigns}
    ...
    + [创建应用程序内营销活动](/help/campaigns/action-campaigns/in-app.md)
    + [配置和发送推送营销活动](/help/campaigns/action-campaigns/push-campaign.md)
    + [创建 Web 营销活动](/help/campaigns/action-campaigns/web-campaign.md)
    + [创建基于代码的体验营销活动](https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer-learn/tutorials/channels/code-based-experience-channel/create-a-code-based-experience-campaign)
...
+ 历程 {#journeys}
  ...
  + [全新历程画布简介](/help/journeys/introduction-to-the-new-journey-canvas.md)
  + [构建历程的简介](/help/journeys/introduction-to-building-a-journey.md)
  + [使用 AI 分析和构建历程](/help/ai-agents/journey-agent-overview.md)
  + [创建测试轮廓](/help/journeys/test-a-journey.md)
  + [使用外部受众模拟历程](/help/journeys/simulate-journeys-with-external-audiences.md)
  + [通过快速模拟加快历程测试](/help/journeys/accelerate-journey-testing-with-quick-simulation.md)
...
+ 渠道 {#channels}
  ...
  + 基于代码的体验渠道{#code-based-experience-channel}
    ...
    + [将表单字段添加到基于代码的体验渠道模板](/help/channels/form-fields-in-code-based-experiences.md)
  ...
  + 电子邮件渠道{#email-channel}
    ...
    + [AI 驱动的符合品牌形象的内容创建 — 教程](https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer-learn/create-on-brand-content/overview)
  + 内容卡{#content-cards}
...
+ 内容管理{#content-management}
  ...
  + [在 Journey Optimizer 中创建符合品牌形象的内容 — 教程](https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer-learn/create-on-brand-content/overview)
...
+ 报告和监测 {#report-and-monitor}
  ...
  + [监控您的自定义操作](/help/report-and-monitor/custom-action-monitoring-report.md)
...
+ 配置 {#configuration}
  + 配置渠道 {#channel-configuration}
    ...
    + 电子邮件渠道 {#email-channel}
      + [创建和 IP 池](/help/set-up-channels/create-ip-pool.md)
...
+ 用例和最佳实践{#use-cases}
  ...
  + 用例战术手册 {#use-case-playbooks}
    ...
    + [创建并发布战术手册实例](https://experienceleague.adobe.com/zh-hans/docs/platform-learn/tutorials/use-case-playbooks/create-and-publish-a-playbook-instance){target="_blank"}
+ 练习、实验室和挑战 {#exercises-and-challenges}
  ...
  + [挑战](https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer-learn/challenges/introduction-and-prerequisites){target="_blank"}
