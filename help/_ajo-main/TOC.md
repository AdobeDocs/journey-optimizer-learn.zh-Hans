...
+ 用例 {#use-cases}
   ...
   + [使用Web SDK在Adobe Journey Optimizer中使用实时天气数据个性化优惠](https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer-learn/personalizing-offers-with-real-time-weather-data/introduction)
   + [在Journey Optimizer中使用排名公式来提供个性化优惠](https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer-learn/personalizing-offers-with-ranking-formulas-based-on-user-zip-code-and-income/introduction)
...
+ 冲突管理 {#conflict-management}
   ...
   + [历程频度上限和优先顺序](/help/conflict-management/journey-frequency-capping-and-prioritization.md)
